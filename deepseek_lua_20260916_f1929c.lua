...
function Library:Unload()
    ...
    if Library._StudGui then
        pcall(function() Library._StudGui:Destroy() end)
        Library._StudGui = nil
    end

    if Library._AutoExecConn then
        pcall(function() Library._AutoExecConn:Disconnect() end)
        Library._AutoExecConn = nil
    end
