--=============================================================================
-- LINORIA LIBRARY | Full Source | Primordial Glass Edition
--=============================================================================
...
--=============================================================================
-- SECTION 07: KEYBIND TRANSPARENCY
--=============================================================================
...
--=============================================================================
-- SECTION 10: PLAYER/TEAM HELPERS
--=============================================================================
...
local function GetPlayerByName(Name)
    for _, Player in next, Players:GetPlayers() do
        if Player.Name == Name or Player.DisplayName == Name then return Player end;
    end;
    return nil;
end;
...
local function GetPlayersByTeam(TeamName)
    local Result = {};
    for _, Player in next, Players:GetPlayers() do
        if Player.Team and Player.Team.Name == TeamName then table.insert(Result, Player) end;
    end;
    return Result;
end;

--=============================================================================
-- SECTION 11: SAFE CALLBACK
--=============================================================================
...
--=============================================================================
-- SECTION 30: NOTIFICATIONS / WATERMARK / KEYBINDS
--=============================================================================
do
...
function Library:CreateWindow(...)
            ...
            ResizeConn = InputService.InputChanged:Connect(function(Change)
                ...
                if Library.WireframeDrag then
                    if not HasMoved then
                        ...
                        Library:Create('UIStroke', { Color = Library.AccentColor; Thickness = 1; ApplyStrokeMode = Enum.ApplyStrokeMode.Border; Parent = Wireframe; });
                    end;
                    if HasMoved and Wireframe then
                        Wireframe.Position = UDim2.fromOffset(TopLeft.X, TopLeft.Y);
                        Wireframe.Size = UDim2.fromOffset(NewW, NewH);
                    end;
                else Outer.Size = UDim2.fromOffset(NewW, NewH); end;
            end);
    ...
    function Library:Toggle()
        ...
        if opening then
            ...
            Outer.Visible = true
            Outer.Size = UDim2.fromOffset(math.max(50, fullSize.X.Offset * 0.96), math.max(50, fullSize.Y.Offset * 0.96))
            ...
            local tOut = TweenService:Create(Outer, TweenInfo.new(FadeTime * 0.9, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                Size = UDim2.fromOffset(math.max(50, fullSize.X.Offset * 0.97), math.max(50, fullSize.Y.Offset * 0.97));
                BackgroundTransparency = 0.5;
            })
            tOut:Play()
...
if InputService.TouchEnabled then
    ...
    local function CreateMobileButton(name, text, startPos)
        ...
        local GradientOverlay = Library:Create('Frame', {
            Name = name .. "Gradient", BackgroundColor3 = Color3.new(1, 1, 1), BorderSizePixel = 0,
            Size = UDim2.new(1, 0, 1, 0), ZIndex = 303, Parent = Inner,
        })
        Library:Create('UIGradient', {
            Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 0.90), NumberSequenceKeypoint.new(1, 1.0) }),
...
local function _LuaX_BuildStud()
    ...
    outer.Name = "Stud"
    outer.Size = UDim2.new(0, 220, 0, 96)
    outer.Position = UDim2.new(1, -240, 0, 20)
    ...
    Library:Create("UICorner", { CornerRadius = UDim.new(0, 8), Parent = accent })
    ...
    local axisY = 42
    local function makeAxis(key, color)
        local bar = Library:Create("Frame", {
            Size = UDim2.new(1, -16, 0, 12),
            Position = UDim2.new(0, 8, 0, axisY),
            BackgroundColor3 = Library.MainColor,
            BorderSizePixel = 0,
            Parent = outer,
        })
        Library:Create("UICorner", { CornerRadius = UDim.new(0, 3), Parent = bar })
        Library:Create("UIStroke", { Color = Library.OutlineColor, Transparency = 0.5, Thickness = 1, Parent = bar })
    ...
    local xFill, xLbl = makeAxis("X", Color3.fromRGB(230, 90, 90))
    local yFill, yLbl = makeAxis("Y", Color3.fromRGB(90, 220, 130))
    local zFill, zLbl = makeAxis("Z", Color3.fromRGB(90, 140, 240))
    ...
    RS.Heartbeat:Connect(function(dt)
        ...
        if hrp then
            ...
            xLbl.Text = "X: " .. fmt(pos.X)
            yLbl.Text = "Y: " .. fmt(pos.Y)
            zLbl.Text = "Z: " .. fmt(pos.Z)
