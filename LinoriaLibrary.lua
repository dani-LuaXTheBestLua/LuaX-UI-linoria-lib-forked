...
local Library = {
    ...
    AccentColor = Color3.fromRGB(200, 120, 160); -- Primordial-style pink
    ...
    GlassEnabled = true;
    GlassTransparency = 0.18; -- main panel glass
    GlassOutlineTransparency = 0.35;
...
function Library:CreateWindow(...)
    ...
    local Outer = Library:Create('Frame', {
        ...
        BackgroundColor3 = Color3.new(0, 0, 0);
        BackgroundTransparency = Library.GlassEnabled and 0.4 or 0;
        BorderSizePixel = 0;
    ...
    local GlassStroke = Library:Create('UIStroke', {
        Color = Library.AccentColor;
        Transparency = Library.GlassEnabled and 0.65 or 1;
        Thickness = 1;
        Parent = Outer;
    });
    Library:AddToRegistry(GlassStroke, { Color = 'AccentColor' });
    ...
    function Library:Toggle()
        ...
        if opening then
            ...
            closeTween.Completed:Connect(function()
                ...
                Outer.BackgroundTransparency = Library.GlassEnabled and 0.4 or 0
                if Inner then
...
function Library:ApplyPrimordialTheme()
    ...
    Library.BackgroundColor = Color3.fromRGB(14, 14, 18)
    Library.AccentColor = Color3.fromRGB(200, 120, 160)
    Library.OutlineColor = Color3.fromRGB(40, 40, 48)
    Library.AccentColorDark = Library:GetDarkerColor(Library.AccentColor)
    Library.GlassEnabled = true
    Library.GlassTransparency = 0.18
...
function Library:SetGlass(Enabled, Transparency)
    ...
    if type(Transparency) == 'number' then
        Library.GlassTransparency = math.clamp(Transparency, 0, 0.6)
    end
end
