...
function Library:MakeResizable(Instance, MinSize)
    -- Visible curved corner resize handle (bottom-right)
    Instance.Active = true
    ...
    local Resizer = Library:Create("TextButton", {
        BackgroundTransparency = 1;
        BorderSizePixel = 0;
        Size = UDim2.fromOffset(GripSize + 6, GripSize + 6);
        Position = UDim2.new(1, -(GripSize + 6), 1, -(GripSize + 6));
        Text = "";
        ZIndex = 50;
    ...
    -- Outer quarter-circle (matches theme accent / outline)
    local Arc = Library:Create("Frame", {
        BackgroundColor3 = Library.AccentColor;
        BackgroundTransparency = 0.35;
        BorderSizePixel = 0;
        Size = UDim2.fromOffset(GripSize * 2, GripSize * 2);
    ...
    Library:AddToRegistry(Arc, { BackgroundColor3 = "AccentColor"; })

    -- Inner cut so only the corner arc shows
    local Cut = Library:Create("Frame", {
        BackgroundColor3 = Library.MainColor;
        BorderSizePixel = 0;
        Size = UDim2.fromOffset(GripSize * 2 - 4, GripSize * 2 - 4);
    ...
    Library:AddToRegistry(Cut, { BackgroundColor3 = "MainColor"; })

    -- 3 diagonal grip lines (classic, always visible)
    for i = 1, 3 do
        local Line = Library:Create("Frame", {
            BackgroundColor3 = Library.FontColor;
            BackgroundTransparency = 0.45;
            BorderSizePixel = 0;
            Size = UDim2.fromOffset(10 - (i - 1) * 2, 1);
            Position = UDim2.new(1, -12 + (i - 1), 1, -6 - (i - 1) * 3);
            Rotation = -45;
            ZIndex = 53;
            Parent = Resizer;
        })
    ...
    local function Finish()
        Dragging = false
        Arc.BackgroundTransparency = 0.35
    end
    ...
    Library:GiveSignal(InputService.InputChanged:Connect(function(Input)
        ...
        local NewX = math.clamp(StartSize.X + Delta.X, MinSize.X, 1e5)
        local NewY = math.clamp(StartSize.Y + Delta.Y, MinSize.Y, 1e5)
        Instance.Size = UDim2.fromOffset(NewX, NewY)
    end))
end
